...
main_page_content = '''
  <body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light justify-content-between">
        <div class="container">
            <a class="navbar-brand" href="#0"><strong>Fresh Tomatoes</strong> Movie Trailers</a>
        </div>
    </nav>
    <div class="container">
...
<div class="col-md-4 col-sm-5 col-xs-8">
    <div class="movie-tile card" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
        ...
        <div class="container">
            <h3 style="text-align: center; transition: all 180ms ease">{movie_title}</h3>
            <p>{movie_storyline}</p>
        </div>
    </div>
</div>
...
def create_movie_tiles_content(movies):
    '''
    For each created instance of 'Movie()' included in the array 'movies' in
    'entertainment_center.py', gather the given data and create a movie tile
    with this data.

    This will create as many movie tiles as you have made movies
    '''
